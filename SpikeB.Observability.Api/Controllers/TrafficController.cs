...
public sealed class TrafficController(DownstreamCollectClient collect) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        return scenario switch
        {
            ...
            "ruby" => collect.RubyAsync(cancellationToken),
            "ruby-slow" => collect.RubySlowAsync(cancellationToken),
            "ruby-error" => collect.RubyErrorAsync(cancellationToken),
            "ruby-timeout" => collect.RubyTimeoutAsync(cancellationToken),
            "ruby-random-latency" => collect.RubyRandomLatencyAsync(cancellationToken),
            "ruby-random-failure" => collect.RubyRandomFailureAsync(cancellationToken),
